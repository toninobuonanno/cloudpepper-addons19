...
class VolontariatoPresidioPrestito(models.Model):
    _inherit = 'volontariato.presidio.prestito'
    ...
    def _compute_movimento_count(self):
        data = self.env['account.move']._read_group(
            [('volontariato_presidio_prestito_id', 'in', self.ids)],
            ['volontariato_presidio_prestito_id'], ['__count'],
        )
    ...
    def action_registra_offerta(self):
        self.ensure_one()
        descrizione = 'Offerta prestito presidi %s' % (self.codice or '')
        ...
        return {
            ...
            'context': {
                ...
                'default_data': self.data_richiesta,
                ...
                'default_presidio_prestito_id': self.id,
            },
        }
    ...
    def action_view_movimenti(self):
        ...
        return {
            ...
            'view_mode': 'list,form',
            'domain': [('volontariato_presidio_prestito_id', '=', self.id)],
        }
